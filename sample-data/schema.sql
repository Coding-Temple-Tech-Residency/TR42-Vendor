...
CREATE TYPE "core"."frequency_type" AS ENUM (
  'ONE_TIME',
  'DAILY',
  'WEEKLY',
  'MONTHLY'
...
CREATE TYPE "core"."role_options" AS ENUM (
  'USER',
  'MANAGER',
  'ADMIN'
);

CREATE TYPE "core"."notification_level" AS ENUM (
  'SUCCESS',
  'DANGER',
  'INFO'
);

CREATE TYPE "core"."device_types" AS ENUM (
  'ANDROID',
  'IOS',
  'TABLET',
  'OTHER'
...
CREATE TYPE "core"."note_categories" AS ENUM (
  'GENERAL',
  'SAFETY',
  'QUALITY',
  'INSTRUCTION'
...
CREATE TYPE "core"."issue_categories" AS ENUM (
  'SAFETY',
  'QUALITY',
  'DELAY',
  'OTHER'
...
CREATE TYPE "core"."issue_severities" AS ENUM (
  'LOW',
  'MEDIUM',
  'HIGH',
  'CRITICAL',
...
CREATE TYPE "core"."compliance_status" AS ENUM (
  'EXPIRED',
  'INCOMPLETE',
  'COMPLETE'
);

CREATE TYPE "core"."priority_status" AS ENUM (
  'LOW',
  'MEDIUM',
  'HIGH'
);
...
CREATE TYPE "core"."contractor_status" AS ENUM (
  'ACTIVE',
  'INACTIVE'
);
...
ALTER TABLE "contractors" ADD CONSTRAINT "contractor_vendor" FOREIGN KEY ("vendor_id") REFERENCES "vendor" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "contractors" ADD CONSTRAINT "contractor_background_check" FOREIGN KEY ("background_check_id") REFERENCES "background_check" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "contractors" ADD CONSTRAINT "contractor_drug_test" FOREIGN KEY ("drug_test_id") REFERENCES "drug_test" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
-- ALTER TABLE "vendor_user" ADD CONSTRAINT "vendor_role_link" FOREIGN KEY ("vendor_user_role") REFERENCES "role" ("id") DEFERRABLE INITIALLY IMMEDIATE;

-- ALTER TABLE "client_user" ADD CONSTRAINT "client_role_link" FOREIGN KEY ("role") REFERENCES "role" ("id") DEFERRABLE INITIALLY IMMEDIATE;

-- ALTER TABLE "contractors" ADD CONSTRAINT "contractor_role_link" FOREIGN KEY ("role") REFERENCES "role" ("id") DEFERRABLE INITIALLY IMMEDIATE;
