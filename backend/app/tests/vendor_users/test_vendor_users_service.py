...
from backend.app.blueprints.vendor_users.vendor_users_service import VendorUserService
...
class TestVendorUserService(unittest.TestCase):
    ...
    @patch(
        "app.blueprints.vendor_users.services.vendor_user_service.VendorUserRepository"
    )
    @patch("app.blueprints.vendor_users.services.vendor_user_service.uuid.uuid4")
