...
from app.blueprints.contractors.services.contractors_service import ContractorService
from app.blueprints.contractors.schemas import contractor_schema, contractors_schema
import logging
...
@contractor_bp.get('/<contractor_id>')
...
def create_contractor():
    try:
        ...
        return jsonify(contractor_schema.dump(contractor)), 201
    except Exception as e:
...
def update_contractor(contractor_id):
    try:
        ...
        return jsonify(contractor_schema.dump(updated)), 200
    except Exception as e:
