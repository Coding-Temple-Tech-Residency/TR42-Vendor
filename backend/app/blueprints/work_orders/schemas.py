...
class WorkOrderSchema(ma.SQLAlchemyAutoSchema):
    ...
    recurrence_type = EnumField(
        FrequencyType, data_key="recurrence_type", allow_none=True
    )
    created_by = fields.String(
        attribute="created_by", data_key="created_by", required=True
    )
    updated_by = fields.String(
        attribute="updated_by", data_key="updated_by", required=True
    )
